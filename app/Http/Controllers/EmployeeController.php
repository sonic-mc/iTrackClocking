...
class EmployeeController extends Controller
{
    ...
    public function clock(Request $request)
    {
        ...
        $geofenceStatus = ($locationLat && $locationLng) ? $this->isWithinGeofence($locationLat, $locationLng, $employee->id) : true;
    ...
    // isWithinGeofence() and haversineDistance() remain unchanged
}
